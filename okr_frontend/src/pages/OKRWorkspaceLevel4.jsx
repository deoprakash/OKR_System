...
const OKRWorkspaceLevel4 = () => {
  ...
  // ...handlers similar to Level 3, plus for new fields...
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-8 relative">
      ...
      <h1 className="text-4xl font-bold mb-8 mt-4 text-center">OKR Workspace - Level 4</h1>
      <form className="w-full max-w-6xl mx-auto">
        ...
        <OKRLevelSection
          level={3}
          employeeCode={fields.level3EmployeeCode}
          employeeName={fields.level3EmployeeName}
          okrDescription={fields.level3OKRDescription}
          okrValue={fields.level3OKRValue}
          onChange={(field, value) => setFields(f => ({ ...f, [`level3${field.charAt(0).toUpperCase() + field.slice(1)}`]: value }))}
        />
        <div className="border border-black rounded bg-white p-6 mb-8">
          <div className="w-fit mx-auto -mt-6 mb-4">
            <span className="bg-black text-white px-6 py-1 rounded text-lg font-bold shadow">Level - 4</span>
          </div>
          <FormRow>
